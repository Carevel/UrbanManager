...
$(function () {
    ...
    for (var i = 0; i < audiodata.length; i++) {
        ...
        if (audiodata[i]["type"] == "0") {
            ahtml += '<div class="row-fluid " style="height: 24px; background-color: #489bcf">' +
                            '<div class="value3span" style="width: 170px !important; margin: 0 0 !important;">' +
                                '<label class="checkbox" style="line-height: 25px; font-size:12px; margin: 0px 0 0 10px; color: #fff;">' +
            '<input type="checkbox" value="' + audiodata[i]["src"] + '" />' + audiodata[i]["name"] + '</label></div><div class="value3span" style="width: 82px !important; margin: 0 0 !important;">' +
                                '<img style="margin: 0px 20px 0 5px;cursor: pointer;" src="' + rootpath + 'Images_flat/sjx.jpg" onclick="Play(\'' + audiodata[i]["src"] + '\');" />' +
                                '<img  style="cursor: pointer;"  src="' + rootpath + 'Images_flat/xz.jpg"  onclick="DownLoad(\'' + audiodata[i]["src"] + '\');" /></div></div>' +
            ...
            ahtml += '<div class="row-fluid " style="height: 24px; background-color: #489bcf">' +
                            '<div class="value3span" style="width: 170px !important; margin: 0 0 !important;">' +
                                '<label class="checkbox" style="line-height: 25px; font-size:12px; margin: 0px 0 0 10px; color: #fff;">' +
            '<input type="checkbox" value="' + audiodata[i]["src"] + '" />' + audiodata[i]["name"] + '</label></div><div class="value3span" style="width: 82px !important; margin: 0 0 !important;">' +
                                '<img  style="margin-left:33px;cursor: pointer;"  src="' + rootpath + 'Images_flat/xz.jpg"  onclick="DownLoad(\'' + audiodata[i]["src"] + '\');" /></div></div>' +
                        '<div style="background-color: #fff; height: 1px;"></div>';
        }
    }
