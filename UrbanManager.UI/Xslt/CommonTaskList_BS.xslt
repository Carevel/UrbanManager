...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:import href="OperationButton_BS.xslt"/>
  <xsl:template match="/">
    <xsl:choose>
    ...
    <div id="tasklistdiv" style="overflow-x: hidden; overflow-y: auto;">
      <xsl:for-each select="taskCollection/taskInfo">
                ...
                <!--<xsl:choose>
                      <xsl:when test="IsCountAllTime!='0'">
                        <xsl:if test="TotalAlarmLight='1'">
                          <div title="{TotalAlarmLightTip}" style="float: left; margin: -2px 0 0 -1px; width: 21px; height: 25px; background: url(../Images_flat/tasklistimg/level1.jpg) no-repeat">
                          </div>
                        </xsl:if>
                        <xsl:if test="TotalAlarmLight='2'">
                          <div title="{TotalAlarmLightTip}" style="float: left; margin: -2px 0 0 -1px; width: 21px; height: 25px; background: url(../Images_flat/tasklistimg/level2.jpg) no-repeat">
                          </div>
                        </xsl:if>
                        <xsl:if test="TotalAlarmLight='3'">
                          <div title="{TotalAlarmLightTip}" style="float: left; margin: -2px 0 0 -1px; width: 21px; height: 25px; background: url(../Images_flat/tasklistimg/level3.jpg) no-repeat">
                          </div>
                        </xsl:if>
                        <xsl:if test="TotalAlarmLight='4'">
                          <div title="{TotalAlarmLightTip}" style="float: left; margin: -2px 0 0 -1px; width: 21px; height: 25px; background: url(../Images_flat/tasklistimg/level4.jpg) no-repeat">
                          </div>
                        </xsl:if>
                      </xsl:when>
                      <xsl:otherwise>
        ...
        <div class="watermarkdiv">
          ...
          <xsl:if test="InfoSourceid='10'">
            <img  src="../Images_flat/watermark/12345.png"/>
          </xsl:if>
          <!--12345水印-->
          <xsl:choose>
            <xsl:when test="'10'='10'">
          ...
          <xsl:choose>
            <xsl:when test="InfoSourceid='10'">
              <xsl:if test="Wp_Source='1'">
                <img  src="../Images_flat/watermark/dh.png"/>
              </xsl:if>
              <xsl:if test="Wp_Source='2'">
                <img  src="../Images_flat/watermark/sj.png"/>
              </xsl:if>
              <xsl:if test="Wp_Source='3'">
                <img  src="../Images_flat/watermark/cz.png"/>
              </xsl:if>
              <xsl:if test="Wp_Source='4'">
                <img  src="../Images_flat/watermark/wx_.png"/>
              </xsl:if>
              <xsl:if test="Wp_Source='5'">
                <img  src="../Images_flat/watermark/xj.png"/>
              </xsl:if>
              <xsl:if test="Wp_Source='7'">
                <img  src="../Images_flat/watermark/rx.png"/>
              </xsl:if>
              <xsl:if test="Wp_Source='9'">
                <img  src="../Images_flat/watermark/glb.png"/>
              </xsl:if>
              <xsl:if test="Wp_Source='0'">
                <img  src="../Images_flat/watermark/wz.png"/>
              </xsl:if>
            </xsl:when>
          </xsl:choose>
          <!--110水印-->
          ...
          <xsl:if test="infoTypeID='1' and ( smallClass='01' or smallClass='02' ) and bigClass='93' and atcodeend ='01' ">
            <img   title="在建" src="../Images_flat/watermark/zj.png"/>
          </xsl:if>
          <xsl:if test="infoTypeID='1' and ( smallClass='01' or smallClass='02' ) and bigClass='93' and atcodeend='02' ">
            <img   title="已建" src="../Images_flat/watermark/yj.png"/>
          </xsl:if>
          <xsl:if  test="IsFast='1' ">
            <img   src="../Images_flat/watermark/kssb.png"/>
          </xsl:if>
          <xsl:if  test="IsPriorityArea='1' ">
            <img   src="../Images_flat/watermark/zdqy.png"/>
          </xsl:if>
          <xsl:if  test="ISWeiXian='1' ">
            <img   src="../Images_flat/watermark/wx.png"/>
          </xsl:if>
          <xsl:if  test="IsThreatened='1' ">
            <img   src="../Images_flat/watermark/yyj.png"/>
          </xsl:if>
          <xsl:if  test="IsFeedBack='1' ">
            <img   src="../Images_flat/watermark/yfk.png"/>
          </xsl:if>
        </div>
        <script>
