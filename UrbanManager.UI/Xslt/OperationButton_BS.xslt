            ...
            <ul id="{taskId}_ul" >
              <xsl:choose>
                ...
                <xsl:when test="$categoryId='0' or $categoryId='0S' ">
                  ...
                  <!--退回外系统-->
                  <xsl:if test="HotLinkSN!='' and IsNotHotLineSN='0' and  IsCallBack!='Y' and (InfoSourceid='2' or InfoSourceid='68') and $isCreatedByMyDept='1' and $categoryId!='4'">
                    <li>
                ...
                <xsl:when test="$categoryId='17' or $categoryId='18' or $categoryId='19' or $categoryId='20'">
                  <xsl:choose>
                    ...
                    <xsl:when test="InfoSourceid='10' or InfoSourceid='11' or InfoSourceid='15' or InfoSourceid='17' or InfoSourceid='2' or InfoSourceid='25' or InfoSourceid='27' or InfoSourceid='34' or InfoSourceid='35' or InfoSourceid='37' or InfoSourceid='46'">
                      <li>
