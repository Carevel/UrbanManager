        ...
        <li>
          ...
          <div class="div_a1">
              ...
              <xsl:choose>
                ...
                <xsl:when test="$categoryId='0' or $categoryId='0S' ">
                  ...
                  <xsl:if test="$categoryId='0S'">
                    <li>
                      <a id="{$taskId}_btn010" onclick="TaskLock.Lock('{$taskId}','{$mainStatus}','../caseoperate_flat/../caseoperate_flat/JianYi/AutoPreCreateCase.aspx?TaskId={$taskId}&amp;categoryId={$categoryId}&amp;page={$page}&amp;returnUrl={$returnUrl}')" >
                        <span>受理</span>
                      </a>
                    </li>
                  </xsl:if>
                  ...
                  <xsl:if test="(HotLinkSN='' or IsNotHotLineSN='1') and $isCreatedByMyDept='1' and $categoryId!='4'">
                    <li>
                      <a id="{$taskId}_btn003" onclick="TaskLock.Lock('{$taskId}','{$mainStatus}','../caseoperate_flat/ZuoFei/CancelCase.aspx?TaskId={$taskId}&amp;categoryId={$categoryId}&amp;page={$page}&amp;returnUrl={$returnUrl}')">
                        <span>作废</span>
                      </a>
                    </li>
                  </xsl:if>
                  <!--退回收集-->
                  <xsl:if test="InfoSourceid!='1' and InfoSourceid!='22'  and InfoSourceid!='68' and InfoSourceid!='2' and InfoSourceid!='10'  and InfoSourceid!='99' and $isCreatedByMyDept='1' and $categoryId!='4'">
                    <li>
                ...
                <xsl:when test="$categoryId='4S'">
                  <li>
                    <a id="{$taskId}_btn005" onclick="TaskLock.Lock('{$taskId}','{$mainStatus}','../caseoperate_flat/HeShi/HeshiCase.aspx?TaskId={$taskId}&amp;categoryId={$categoryId}&amp;page={$page}&amp;returnUrl={$returnUrl}')">
                      <span>核实</span>
                    </a>
                  </li>
                </xsl:when>
                ...
                <!--派遣-->
                <xsl:when test="$categoryId='7' or $categoryId='7B' or  $categoryId='7C' ">
                  ...
                  <xsl:if test="isDisDeptType='-1' and $categoryId!='7C' ">
                    <!--7C不进回退立案-->
                    <li>
                ...
                <!--再派遣-->
                <xsl:when test="$categoryId='7A' or $categoryId='67' ">
                  <li>
                    <a id="{$taskId}_btn014" onclick="TaskLock.Lock('{$taskId}','{$mainStatus}','../caseoperate_flat/Dispatch/DispatchCase.aspx?TaskId={$taskId}&amp;categoryId={$categoryId}&amp;solvingId={$solvingId}&amp;page={$page}&amp;returnUrl={$returnUrl}')">
                      <span>再派遣</span>
                    </a>
                  ...
                  <xsl:if test="PlatformType='1'">
                    ...
                    <xsl:if test="hechaAuthorized='1'and isHeChaInfiSource != '0' ">
                      <li>
                ...
                <!--督办（已完成、未完成、查询） -->
                <xsl:when test="$categoryId='8' or $categoryId='9' or $categoryId='9A'">
                ...
                <xsl:when test="$categoryId='14'">
                  ...
                  <xsl:if test="InfoSourceid='10' and IsFeedBack='0' ">
                    <li>
                ...
                <xsl:when test="$categoryId='17' or $categoryId='18' or $categoryId='19' or $categoryId='20'">
                  <xsl:choose>
                    <xsl:when test="InfoSourceid='10' or InfoSourceid='55' or InfoSourceid='6' or InfoSourceid='9' or InfoSourceid='44' or InfoSourceid='48' or InfoSourceid='7' or InfoSourceid='50' ">
                      <li>
            ...
            <img src="../Images/TaskDelay01.gif" onclick="TaskLock.Lock('{$taskId}','{$mainStatus}','ChuLi/ApplyPostpone.aspx?TaskId={$taskId}&amp;categoryId={$categoryId}&amp;solvingId={$solvingId}&amp;page={$page}&amp;returnUrl={$returnUrl}')" alt="申请缓办" border="0" style="cursor:hand;"/>
                ...
                <!--领导督办-->
                <xsl:when test="$categoryId='61' or $categoryId='62'or $categoryId='63' or $categoryId='76'or $categoryId='77' or $categoryId='87'">
                  <li>
                    <a onclick="TaskLock.Lock('{$taskId}','{$mainStatus}','../caseoperate_flat/DuBan/Gzdb_LOpinionInput.aspx?TaskId={$taskId}&amp;categoryId={$categoryId}&amp;solvingId={$solvingId}&amp;IsDelay=2&amp;page={$page}&amp;returnUrl={$returnUrl}')">
                      <span>领导督办</span>
                    </a>
