  ...
  <xsl:template name="tplOperationButton">
    ...
    <xsl:variable name="returnUrl">
      <xsl:choose>
        ...
        <xsl:when test="$categoryId='73'">JianGuanList.aspx?categoryId=<xsl:value-of select="$categoryId"/>
        </xsl:when>
        <xsl:when test="$categoryId='82'">TeShuAnJianList.aspx?categoryId=<xsl:value-of select="$categoryId"/>
        </xsl:when>
            ...
            <ul id="{taskId}_ul" >
              <xsl:choose>
                ...
                <xsl:when test="$categoryId='0' or $categoryId='0S' ">
                  ...
                  <!--退回收集-->
                  <!--<xsl:if test="HotLinkSN!='' and IsNotHotLineSN='0' and $isCreatedByMyDept='1' and $categoryId!='4'"> 测试用条件 Add gcx At 2015-01-29-->
                  <xsl:if test="InfoSourceid!='15' and InfoSourceid!='1' and InfoSourceid!='22' and InfoSourceid!='2' and InfoSourceid!='10' and InfoSourceid!='99'  and InfoSourceid!='68' and $isCreatedByMyDept='1' and $categoryId!='4'">
                    <li>
                  ...
                  <!--退回外系统-->
                  <xsl:if test="HotLinkSN!='' and  IsCallBack!='Y' and IsNotHotLineSN='0' and ( InfoSourceid='2' or InfoSourceid='68' )    and $isCreatedByMyDept='1' and $categoryId!='4'">
                    <li>
                ...
                <xsl:when test="$categoryId='8' or $categoryId='9' or $categoryId='9A' or $categoryId='9B'">
                  <xsl:if test="$categoryId='8'">
                    ...
                    <xsl:if test="UserDeptCode='101' and (InfoSourceid='10' or InfoSourceid='68')">
                      <li>
                        <a id="{$taskId}_btn042" onclick="TaskLock.Lock('{$taskId}','{$mainStatus}','../caseoperate_flat/DuBan/CaseRefilling.aspx?TaskId={$taskId}&amp;categoryId={$categoryId}&amp;solvingId={$solvingId}&amp;page={$page}&amp;returnUrl={$returnUrl}')">
                          <span>发回重填</span>
                        </a>
                      </li>
                    </xsl:if>
                ...
                <xsl:when test="$categoryId='9S' or $categoryId='9C'">
                  ...
                  <xsl:if test="$isCreatedByMyDept='0'">
                    <!--<xsl:if test="HotLinkSN!='' and InfoSourceid='10'">
                      <li>
                        <a id="{$taskId}_btn033" onclick="TaskLock.Lock('{$taskId}','{$mainStatus}','../caseoperate_flat/HeCha/SendToTelask.aspx?TaskId={$taskId}&amp;categoryId={$categoryId}&amp;solvingId={$solvingId}&amp;page={$page}&amp;returnUrl={$returnUrl}')">
                          <span>热线回访</span>
                        </a>
                      </li>
                    ...
                    -->
                    <xsl:if test=" Solvingvisitcount>0 or InfoSourceid !='10' or UserStreetCode='' or UserStreetCode='0'">
                      <li>
                        <a id="{$taskId}_btn026" onclick="TaskLock.Lock('{$taskId}','{$mainStatus}','../caseoperate_flat/JianYi/AutoSupervisionCase.aspx?TaskId={$taskId}&amp;categoryId={$categoryId}&amp;solvingId={$solvingId}&amp;page={$page}&amp;returnUrl={$returnUrl}')">
                          <span>申请结案</span>
                        </a>
                ...
                <xsl:when test="$categoryId='8S'">
                  ...
                  <xsl:if test="$isCreatedByMyDept='0'">
                    <xsl:if test="(InfoSourceid='10' or InfoSourceid='68' or InfoSourceid='11' or InfoSourceid='15' or InfoSourceid='25' or InfoSourceid='34' or InfoSourceid='35' or InfoSourceid='37' or InfoSourceid='46') and ( UserStreetCode!='' or UserStreetCode!='0')">
                      <li>
                        <a id="{$taskId}_btn033" onclick="TaskLock.Lock('{$taskId}','{$mainStatus}','../caseoperate_flat/HeCha/SendToTelask.aspx?TaskId={$taskId}&amp;categoryId={$categoryId}&amp;solvingId={$solvingId}&amp;page={$page}&amp;returnUrl={$returnUrl}')">
                          <span>热线回访</span>
                        </a>
                    ...
                    <xsl:if test=" Solvingvisitcount>0 or (InfoSourceid !='10' and InfoSourceid !='68') or UserStreetCode='' or UserStreetCode='0'">
                      <li>
                        <a id="{$taskId}_btn026" onclick="TaskLock.Lock('{$taskId}','{$mainStatus}','../caseoperate_flat/JianYi/AutoSupervisionCase.aspx?TaskId={$taskId}&amp;categoryId={$categoryId}&amp;solvingId={$solvingId}&amp;page={$page}&amp;returnUrl={$returnUrl}')">
                          <span>申请结案</span>
                        </a>
                ...
                <xsl:when test="$categoryId='14'">
                  ...
                  <xsl:if test="InfoSourceid='2' or InfoSourceid='10' or InfoSourceid='15' or InfoSourceid='25' or InfoSourceid='27'">
                    <li>
                      <a id="{$taskId}_btn033" onclick="TaskLock.Lock('{$taskId}','{$mainStatus}','../caseoperate_flat/HeCha/SendToTelask.aspx?TaskId={$taskId}&amp;categoryId={$categoryId}&amp;page={$page}&amp;returnUrl={$returnUrl}')">
                        <span>再次回访</span>
                      </a>
                ...
                <xsl:when test="$categoryId='17' or $categoryId='18' or $categoryId='19' or $categoryId='20'">
                  <xsl:choose>
                    <!--xsl:when test="InfoSourceid='10' or InfoSourceid='2' or InfoSourceid='55' or InfoSourceid='6' or InfoSourceid='9' or InfoSourceid='48' or InfoSourceid='7' or InfoSourceid='49' or InfoSourceid='50' or InfoSourceid='46' "-->
                    <xsl:when test="InfoSourceid='10' or InfoSourceid='11' or InfoSourceid='15' or InfoSourceid='17' or InfoSourceid='68' or InfoSourceid='2' or InfoSourceid='25' or InfoSourceid='27' or InfoSourceid='34' or InfoSourceid='35' or InfoSourceid='37' or InfoSourceid='46'">
                      <li>
                ...
                <!--领导督办-->
                <xsl:when test="$categoryId='61' or $categoryId='62'or $categoryId='63' or $categoryId='76'or $categoryId='77' or $categoryId='86' or $categoryId='87' ">
                  <li>
                ...
                <xsl:when test="$categoryId='73'">
                  <!--立案监管-->
                  <li>
                    <a  onclick="TaskLock.Lock('{$taskId}','{$mainStatus}','../caseoperate_flat/CaseJianGuan/JianGuanInput.aspx?TaskId={$taskId}&amp;categoryId={$categoryId}&amp;solvingId={$solvingId}&amp;IsDelay=2&amp;page={$page}&amp;returnUrl={$returnUrl}')">
                      <span>立案监管</span>
                    </a>
                  </li>
                </xsl:when>
                <xsl:when test="$categoryId='74'">
                  <!--结案监管-->
                  <li>
                    <a  onclick="TaskLock.Lock('{$taskId}','{$mainStatus}','../caseoperate_flat/CaseJianGuan/JianGuanInput.aspx?TaskId={$taskId}&amp;categoryId={$categoryId}&amp;solvingId={$solvingId}&amp;IsDelay=2&amp;page={$page}&amp;returnUrl={$returnUrl}')">
                      <span>结案监管</span>
                ...
                <xsl:when  test="$categoryId='79' or $categoryId='84' or $categoryId='85'">
                  <li>
                    <a onclick="TaskLock.Lock('{$taskId}','{$mainStatus}','../caseoperate_flat/CaseJianGuan/JianGuanInput.aspx?TaskId={$taskId}&amp;categoryId={$categoryId}&amp;solvingId={$solvingId}&amp;IsDelay=2&amp;page={$page}&amp;returnUrl={$returnUrl}')">
                      <span>退单监管</span>
                    </a>
