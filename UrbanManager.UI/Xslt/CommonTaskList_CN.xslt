...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:import href="OperationButton_CN.xslt"/>
  <xsl:template match="/">
    <xsl:choose>
    ...
    <div id="tasklistdiv" style="overflow-x: hidden; overflow-y: auto;">
      <xsl:for-each select="taskCollection/taskInfo">
          ...
          <table class="taskinfo">
            ...
            <tr>
              ...
              <td>
                ...
                <xsl:if test="HeChaCount>2">
                  <img class="taskicon" src="../Images_flat/taskicon/dchc.jpg"  title="多次核查"/>
                </xsl:if>
                ...
                <xsl:if test="DeptBackCheckPass='0'">
                  <img class="taskicon" src="../Images_flat/taskicon/tdbtg.jpg"  title="退单不通过"/>
                </xsl:if>
              ...
              <td>案卷编号:<xsl:value-of select="caseSn"/>
              </td>
              <td>
                责任网格:<xsl:value-of select="WorkGridCode"/>
              </td>
              <td colspan="2">
                <xsl:choose>
        ...
        <div class="watermarkdiv">
          ...
          <xsl:if  test="InfoSourceid='2' ">
            <img   src="../Images_flat/watermark/12319.png"/>
          </xsl:if>
          <xsl:if  test="InfoSourceid='42' ">
            <img   src="../Images_flat/watermark/sjdc.png"/>
          </xsl:if>
          <xsl:if  test="InfoSourceid='7' ">
            <img  src="../Images_flat/watermark/mtts.png"/>
          </xsl:if>
          ...
          <xsl:if test="ISWeiXian='1'">
            <img  title="危险事部件" src="../Images_flat/watermark/wx.png"/>
          </xsl:if>
        </div>
        <script>
